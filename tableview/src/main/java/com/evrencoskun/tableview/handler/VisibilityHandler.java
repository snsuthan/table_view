...
public class VisibilityHandler
{
  ...
  private void showRow(int row, boolean removeFromList)
  {
    ...
    if (hiddenRow != null)
    {
      ...
      mTableView.getAdapter().addRow(row, hiddenRow.getRowHeaderModel(), hiddenRow.getCellModelList());
    }
    else
    {
  ...
  public void hideColumn(int column)
  {
    ...
    mTableView.setColumnWidth(column, 0);
    mTableView.getColumnHeaderLayoutManager().getViewHolder(column).itemView.setVisibility(View.INVISIBLE);
    mTableView.getCellLayoutManager().remeasureAllChild();
  ...
  private void showColumn(int column, boolean removeFromList)
  {
    ...
    {
      mTableView.remeasureColumnWidth(column);
      mTableView.getColumnHeaderLayoutManager().getViewHolder(column).itemView.setVisibility(View.VISIBLE);
    }
    else
    {
  ...
  private Column getColumnValueFromPosition(int column)
  {
    ...
    List<Object> cellModelList = (List<Object>) mTableView.getAdapter().getCellColumnItems(column);
