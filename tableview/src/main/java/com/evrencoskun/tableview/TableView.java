...
public class TableView extends FrameLayout implements ITableView
{
  ...
  private void initialDefaultValues(AttributeSet attrs)
  {
    ...
    // Colors
    mSelectedColor = ContextCompat.getColor(getContext(), R.color.table_view_default_selected_background_color);
    mUnSelectedColor = ContextCompat.getColor(getContext(), R.color.table_view_default_unselected_background_color);
    mShadowColor = ContextCompat.getColor(getContext(), R.color.table_view_default_shadow_background_color);
    ...
    {
      // Dimensions
      mRowHeaderWidth = (int) a.getDimension(R.styleable.TableView_row_header_width, mRowHeaderWidth);
      mColumnHeaderHeight = (int) a.getDimension(R.styleable.TableView_column_header_height, mColumnHeaderHeight);
      ...
      mSeparatorColor = a.getColor(R.styleable.TableView_separator_color,
                                   ContextCompat.getColor(getContext(), R.color.table_view_default_separator_color));

      // Booleans
      mShowVerticalSeparators = a.getBoolean(R.styleable.TableView_show_vertical_separator, mShowVerticalSeparators);
      mShowHorizontalSeparators =
        a.getBoolean(R.styleable.TableView_show_horizontal_separator, mShowHorizontalSeparators);
  ...
  protected void initializeListeners()
  {
    ...
    mRowHeaderRecyclerViewItemClickListener = new RowHeaderRecyclerViewItemClickListener(mRowHeaderRecyclerView, this);
  ...
  public void setAdapter(AbstractTableAdapter tableAdapter)
  {
    if (tableAdapter != null)
    {
      ...
      {
        throw new IllegalArgumentException("mColumnHeaderRecyclerView");
      }
      ...
      {
        throw new IllegalArgumentException("mRowHeaderRecyclerView");
      }
      ...
      {
        throw new IllegalArgumentException("mCellRecyclerView");
      }
    }
  }
  ...
  @Override public boolean isIgnoreSelectionColors()
  {
  ...
  @Override public boolean isShowHorizontalSeparators()
  {
  ...
  @Override public boolean isShowVerticalSeparators()
  {
  ...
  @Override public CellRecyclerView getCellRecyclerView()
  {
    return mCellRecyclerView;
  }

  @Override public CellRecyclerView getColumnHeaderRecyclerView()
  {
    return mColumnHeaderRecyclerView;
  }

  @Override public CellRecyclerView getRowHeaderRecyclerView()
  {
    return mRowHeaderRecyclerView;
  }

  @Override public ColumnHeaderLayoutManager getColumnHeaderLayoutManager()
  {
  ...
  @Override public CellLayoutManager getCellLayoutManager()
  {
  ...
  @Override public LinearLayoutManager getRowHeaderLayoutManager()
  {
    if (mRowHeaderLayoutManager == null)
    {
      mRowHeaderLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
    }
    return mRowHeaderLayoutManager;
  }

  @Override public HorizontalRecyclerViewListener getHorizontalRecyclerViewListener()
  {
    return mHorizontalRecyclerViewListener;
  }

  @Override public VerticalRecyclerViewListener getVerticalRecyclerViewListener()
  {
    return mVerticalRecyclerListener;
  }

  @Override public ITableViewListener getTableViewListener()
  {
  ...
  @Override public void sortColumn(int columnPosition, SortState sortState)
  {
    mIsSortable = true;
    mColumnSortHandler.sort(columnPosition, sortState);
  }

  @Override public void sortRowHeader(SortState sortState)
  {
    mIsSortable = true;
    mColumnSortHandler.sortByRowHeader(sortState);
  }

  @Override public void remeasureColumnWidth(int column)
  {
  ...
  @Override public AbstractTableAdapter getAdapter()
  {
    return mTableAdapter;
  }

  @Override public void filter(Filter filter)
  {
    mFilterHandler.filter(filter);
  }

  @Override public FilterHandler getFilterHandler()
  {
    return mFilterHandler;
  }

  @Override public SortState getSortingStatus(int column)
  {
    return mColumnSortHandler.getSortingStatus(column);
  }

  @Override public SortState getRowHeaderSortingStatus()
  {
    return mColumnSortHandler.getRowHeaderSortingStatus();
  }

  @Override public void scrollToColumnPosition(int column)
  {
    mScrollHandler.scrollToColumnPosition(column);
  }

  @Override public void scrollToColumnPosition(int column, int offset)
  {
    mScrollHandler.scrollToColumnPosition(column, offset);
  }

  @Override public void scrollToRowPosition(int row)
  {
    mScrollHandler.scrollToRowPosition(row);
  }

  @Override public void scrollToRowPosition(int row, int offset)
  {
  ...
  @Override public void showRow(int row)
  {
    mVisibilityHandler.showRow(row);
  }

  @Override public void hideRow(int row)
  {
    mVisibilityHandler.hideRow(row);
  }

  @Override public void showAllHiddenRows()
  {
    mVisibilityHandler.showAllHiddenRows();
  }

  @Override public void clearHiddenRowList()
  {
    mVisibilityHandler.clearHideRowList();
  }

  @Override public void showColumn(int column)
  {
    mVisibilityHandler.showColumn(column);
  }

  @Override public void hideColumn(int column)
  {
    mVisibilityHandler.hideColumn(column);
  }

  @Override public boolean isColumnVisible(int column)
  {
    return mVisibilityHandler.isColumnVisible(column);
  }

  @Override public void showAllHiddenColumns()
  {
    mVisibilityHandler.showAllHiddenColumns();
  }

  @Override public void clearHiddenColumnList()
  {
    mVisibilityHandler.clearHideColumnList();
  }

  @Override public boolean isRowVisible(int row)
  {
  ...
  @Override public SelectionHandler getSelectionHandler()
  {
    return mSelectionHandler;
  }

  @Override public ColumnSortHandler getColumnSortHandler()
  {
    return mColumnSortHandler;
  }

  @Override public DividerItemDecoration getHorizontalItemDecoration()
  {
  ...
  @Override public DividerItemDecoration getVerticalItemDecoration()
  {
  ...
  @Override public @ColorInt int getSelectedColor()
  {
  ...
  @Override public @ColorInt int getSeparatorColor()
  {
  ...
  @Override public @ColorInt int getUnSelectedColor()
  {
  ...
  @Override public @ColorInt int getShadowColor()
  {
    return mShadowColor;
  }
   ...
   */
  @Override public int getRowHeaderWidth()
  {
   ...
   */
  @Override public void setRowHeaderWidth(int rowHeaderWidth)
  {
